  ...
  <div class="orderEcom">
    ...
    <section class="orderEcom-main">
      <el-tabs v-model="activeName" @tab-click="handleClick" class="tabs">
            ...
            <div class="allList">
              <div class="screen">
                ...
                <div class="screen-list">
                  <span style="line-height: 35px">选择日期：</span>
                  <div class="block">
                    <el-date-picker
                      v-model="startTime1"
                      type="daterange"
              ...
              <el-table
                ...
                <el-table-column label="商品" prop="product_name" sortable>
        ...
        <el-tab-pane label="待兑换" name="third">
          <div class="allList">
        ...
        <el-tab-pane label="兑换成功" name="fourth">
          <div class="allList">
            <div class="screen" style="line-height: 65px">
              <div class="screen-list" style="margin-left: 30px">
                <el-select v-model="oderCode_value1" placeholder="请选择" style="width: 120px">
        ...
        <el-tab-pane label="兑换失败" name="accomplish">
          <div class="allList">
            <div class="screen" style="line-height: 65px">
              <div class="screen-list" style="margin-left: 30px">
                <el-select v-model="oderCode_value1" placeholder="请选择" style="width: 120px">
  ...
  export default {
    ...
    methods: {
      handleClick(tab, event) {
        switch(this.activeName){
          case 'all':
            ...
            this.search_value1 = ''
            this.$axios.post('/credit_card_integral/indexList').then((response) =>{
          ...
          case 'second':
            ...
            this.$axios.post('/credit_card_integral/indexList',secondData)
              .then((response) =>{
          ...
          case 'third':
            ...
            this.$axios.post('/credit_card_integral/indexList',thirdData)
              .then((response) =>{
          ...
          case 'fourth':
            ...
            this.$axios.post('/credit_card_integral/indexList',fourthData)
              .then((response) =>{
          ...
          case 'accomplish':
            ...
            this.$axios.post('/credit_card_integral/indexList',accomplishData)
              .then((response) =>{
      ...
      pushOrderDetails(index, row){
        //console.log(row)
        this.$router.push({name:'IntegralInfo',query:{'data':row}})
      },
      //订单号筛选
      sendOerderCode(){
        switch(this.activeName){
          case 'all':
              ...
              this.$axios.post('/credit_card_integral/indexList',sedData).then((response) =>{
                  this.tableData = response.data.data
                })
            break;
          case 'second':
              ...
              this.$axios.post('/credit_card_integral/indexList',sedData1).then((response) =>{
                  this.tableData_second = response.data.data
                })
            break;
          case 'third':
              ...
              //全部订单
              this.$axios.post('/credit_card_integral/indexList',sedData2).then((response) =>{
                  this.tableData_third = response.data.data
                })
            break;
          case 'fourth':
              ...
              this.$axios.post('/credit_card_integral/indexList',sedData3).then((response) =>{
                  this.tableData_fourth = response.data.data
                })
            break;
          case 'accomplish':
              ...
              this.$axios.post('/credit_card_integral/indexList',sedData4).then((response) =>{
                  this.tableData_accomplish = response.data.data
                })
            break;
          default:
        ...
        switch(this.activeName){
          case 'all':
            if(this.startTime1 === ''){
              ...
              //全部订单
              this.$axios.post('/credit_card_integral/indexList',sedData)
                .then((response) =>{
                  this.tableData = response.data.data
                })
            }else {
